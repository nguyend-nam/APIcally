        ...
        <Layout>
          <Row gutter={[20, 20]}>
            ...
            <Col span={24} xl={{ span: 16 }}>
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-2 !mt-6 md:!mt-12 mb-4">
                <Typography.Title
                  level={3}
                    ...
                    {["day", "month", "year"].map((log) => {
                      return (
                        ...
                        >
                          <Text
                            className={cx(
                              "text-sm md:text-base !m-0 !-my-1 md:!-my-2 font-medium",
                              {
              ...
              <Typography.Title
                level={3}
                className="!m-0 !text-xl md:!text-2xl !mt-6 !md:mt-12 !mb-4"
              >
                History
              </Typography.Title>
